...
# eximagination conf
EXIMAGINATION_MEDIA_ROOT = PROJECT_DIR(
    os.path.join(MEDIA_ROOT, 'external_images')
)
...
LOGGING = {
    ...
    'handlers': {
        ...
        'eximagination_log': {
            'level': 'DEBUG',
            'class': 'logging.handlers.RotatingFileHandler',
            'filename': PROJECT_DIR("../../logs/eximagination.log"),
            'maxBytes': 1048576,
            'backupCount': 99,
            'formatter': 'verbose',
        },
    ...
    'loggers': {
        ...
        'eximagination': {
            'handlers': ['console', 'eximagination_log'],
            'level': 'DEBUG',
            'propagate': True,
        },
    },
...
# installation.
if DEV:
    app_path = os.environ.get('APP_SOURCE_PATH', 'src')
