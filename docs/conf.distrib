# -*- coding: utf-8 -*-
#
# django-eximagination documentation build configuration file, created by
...
try:
    import eximagination
    from simple import settings as example_settings
    version = eximagination.__version__
    project = eximagination.__title__
    copyright = eximagination.__copyright__
except Exception as e:
    version = '0.1'
    project = u'django-eximagination'
...
htmlhelp_basename = 'django-eximaginationdoc'
...
latex_documents = [
  ('index',
   'django-eximagination.tex',
   u'django-eximagination Documentation',
...
epub_title = u'django-eximagination'
